...
public class PatientDAO {
    ...
    public boolean updatePasswordIfMatch(int accountPatientId, String oldPassword, String newPassword) {
        String checkSql = "SELECT password FROM AccountPatient WHERE account_patient_id = ?";
        String updateSql = "UPDATE AccountPatient SET password = ? WHERE account_patient_id = ?";
